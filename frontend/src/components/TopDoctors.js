...
const TopDoctors = () => {
    ...
    // const doctors=useContext(AppContext) can also get doctors from app context
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10 '>
        ...
        <button onClick={()=>{navigate('/doctors') }} className='text-gray-600 px-12 py-3 rounded-full mt-10 bg-blue-100'>More</button>
    </div>
  )
}
